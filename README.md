...
| `--ppt` / `--no-ppt` | Move packet headers into PPT markers. Supported for single-tile RPCL with one part or `R` resolution parts and SOP/EPH disabled; multi-tile and other combinations fail closed. |
