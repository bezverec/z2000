...
Recommended order when resuming the push: **POC tile-part breadth** (finish
reference-grid position `P` parts) or **N6** (biggest unlock but budget it as a
