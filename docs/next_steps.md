...
| T2 9→10 | **PPM** main-header packed packet headers (standalone checked `Zppm`/`Nppm`/`Ippm` framing and single-/multi-tile RPCL PPT landed 2026-07-12) | Medium (main-header parsing plus tile-part group distribution) | Low–medium | Partial: framing unit tests are local and z2000/OpenJPEG/Grok/Kakadu decode public one-part, three-part, and 16-tile/48-part PPT output losslessly; no independent PPM producer fixture yet |
