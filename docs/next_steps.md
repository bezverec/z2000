...
| T2 9→10 | **PPM + multi-tile PPT** packed packet headers (single-tile one/`R`-part PPT landed 2026-07-12) | Medium (per-tile Z/header state and main-header tile-part distribution) | Low–medium | Partial: z2000/OpenJPEG/Grok/Kakadu decode public one- and three-part PPT output losslessly; no independent PPM producer fixture yet |
