...
| T2 9→10 | **PPM + multipart PPT** packed packet headers (single-part PPT landed 2026-07-12) | Medium (shared Z/header state and main-header tile-part distribution) | Low–medium | Partial: z2000/OpenJPEG/Grok/Kakadu decode the public single-part PPT output losslessly; no independent PPM producer fixture yet |
