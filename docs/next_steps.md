...
| T2 9→10 | **Multi-tile PPM** main-header packed packet headers (checked framing plus single-tile PPM and single-/multi-tile PPT landed 2026-07-12) | Medium (global group order plus per-tile T2 state) | Low–medium | Partial: z2000/OpenJPEG/Grok/Kakadu decode public three-part PPM and one-/three-/48-part PPT output losslessly; no independent foreign PPM producer fixture yet |
